...
----------
<br>有些人是通过语言指示别人做事,有些人是通过操作工具解决问题.
<br>过去执行末端起作用的是肌肉力量,随着时代的发展现在起作用的可以是微服务.
<br>从'巴科斯-诺尔范式'起源来讲,微服务也可以被看做一种语言.
<br>所以我在过去一年借助llm对语言的应用,结合以数字孪生为核心的微服务,搭建了自己的代理应用.
